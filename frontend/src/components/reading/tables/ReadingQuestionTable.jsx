                    ...
                    >
                      ...
                      <td className={classes}>
                        <div>
                          <Typography
                            variant="small"
                            className="font-medium cursor-pointer hover:text-blue-300 text-slate-900 dark:text-slate-200" // ✨ Đổi màu
                      ...
                      <td className={classes}>
                        <Typography
                          variant="small"
                          className="font-bold text-center text-blue-400" // ✨ Đổi màu
                        >
                          {question.points || 5}
                        </Typography>
                      </td>
        ...
        <DialogBody className="space-y-4 max-h-[60vh] overflow-y-auto border-b border-primary">
          {previewDialog.question ? (
            <div className="space-y-4">
              ...
              {/* Correct Answer (for other types) - ✨ Logic này đúng cho cả SHORT_ANSWER */}
              {previewDialog.question.questionType !== "MULTIPLE_CHOICE" &&
