...
const AdminGrammarTopicEdit = () => {
  ...
  const fetchTopic = async () => {
    try {
      // Sử dụng getTopicById nếu có, hoặc filter từ getAllTopics
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await grammarAdminAPI.updateTopic(id, submitData);
      toast.success("Cập nhật chủ đề thành công!");
      navigate(ADMIN_ROUTES.GRAMMAR_TOPICS);
    } catch (error) {
      console.error("Update topic error:", error);
      toast.error(error.response?.data?.message || "Cập nhật chủ đề thất bại");
    } finally {
      setSaving(false);
    }
  };
    ...
    <div className="w-full max-w-4xl mx-auto space-y-6">
      ...
      <Card className="border border-blue-gray-100">
        <CardBody className="p-4">
          ...
          <Progress value={getCompletionPercentage()} color="orange" size="sm" />
        </CardBody>
      </Card>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Basic Information */}
            <Card className="border border-blue-gray-100">
              <CardHeader floated={false} shadow={false} className="m-0 p-4 border-b border-blue-gray-100">
              ...
              <CardBody className="p-6 space-y-6">
                <div>
                  ...
                  <Input
                    ...
                    error={!!errors.name}
                    className="!border-blue-gray-200 focus:!border-orange-500"
                    labelProps={{
            ...
            <Card className="border border-orange-200 bg-orange-50">
              <CardBody className="p-4">
                <div className="flex items-start space-x-2">
                  <InformationCircleIcon className="h-5 w-5 text-orange-600 mt-0.5 flex-shrink-0" />
                  <div>
          ...
          <CardBody className="p-6">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                loading={saving}
                className="bg-gradient-to-r from-orange-500 to-orange-600 shadow-lg min-w-[140px]"
              >
                {saving ? (
                  "Đang lưu..."
                ) : (
