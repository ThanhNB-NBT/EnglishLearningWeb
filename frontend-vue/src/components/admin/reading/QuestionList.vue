<!-- src/components/admin/reading/QuestionList.vue - FIXED -->
<template>
...
const store = useReadingAdminStore()
...
// ==================== CONFIG ====================
const readingConfig = computed(() => ({
  // Module info
  moduleType: 'READING',
  topicLabel: 'Chủ đề',
  lessonLabel: 'Bài đọc',
  contentLabel: 'Nội dung bài đọc',
