    ...
    <div class="flex-1 flex overflow-hidden bg-gray-100 dark:bg-[#121212] h-[80vh]">
      <transition name="el-fade-in-linear">
        ...
        >
          ...
          >
            <el-icon class="mr-2"><Document /></el-icon> Nội dung bài đọc
          </div>
...
import { useReadingQuestionForm } from '@/composables/reading/useReadingQuestions'
import QuillRichEditor from '@/components/common/QuillRichEditor.vue'
import { Close, Reading, Document, Tools } from '@element-plus/icons-vue'
