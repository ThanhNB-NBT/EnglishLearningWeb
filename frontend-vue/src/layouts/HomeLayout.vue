<template>
  <div
    class="min-h-screen flex w-full bg-gray-50 dark:bg-[#141414] transition-colors duration-300 font-sans"
  >
    <div
    ...
    >
      ...
      >
        <div class="flex items-center gap-3 overflow-hidden w-full">
          <div
            class="w-9 h-9 rounded-lg bg-indigo-600 flex items-center justify-center text-white shrink-0 shadow-md"
          >
      ...
      <div
        class="p-3 border-t border-solid border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-[#1f1f1f]"
      >
        <button
          @click="toggleSidebar"
          ...
          <el-dropdown @command="handleCommand" trigger="click">
            ...
            >
              <el-avatar
                :size="36"
                :src="userAvatar"
                class="border-2 border-gray-300 dark:border-gray-500 shadow-sm bg-gray-200"
              />
            </div>
            <template #dropdown>
              <el-dropdown-menu
              ...
              >
                ...
                <el-dropdown-item
                  command="profile"
                  class="!rounded-md gap-2 dark:text-gray-300 dark:hover:bg-[#333]"
                  ><el-icon>
                    <User />
                  </el-icon>
                  Hồ sơ</el-dropdown-item
                >
                <el-dropdown-item
                  ...
                  Mật khẩu</el-dropdown-item
                >
                <el-dropdown-item
                  command="logout"
                  class="!text-red-500 !rounded-md gap-2 dark:hover:bg-red-900/20"
                  ><el-icon>
                    <SwitchButton />
                  </el-icon>
...
import { getAvatarUrl } from '@/utils/avatar' // ✅ FIX: Import
import {
  Odometer,
  Reading,
  Document,
