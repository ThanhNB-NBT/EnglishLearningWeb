    ...
    >
      ...
      <el-scrollbar class="sidebar-scrollbar">
        ...
        >
          ...
          <el-menu-item index="/user/grammar">
            <el-icon><Reading /></el-icon>
            <template #title>Ngữ pháp</template>
          </el-menu-item>

          <el-menu-item index="/user/reading">
            <el-icon><Document /></el-icon>
            <template #title>Đọc hiểu</template>
          </el-menu-item>
        </el-menu>
      </el-scrollbar>

      <!-- Collapse Button - FIXED AT BOTTOM OF SIDEBAR -->
    ...
    <el-container class="main-container">
      ...
      <el-header class="header">
        ...
        <el-breadcrumb separator="/" class="breadcrumb">
          <el-breadcrumb-item :to="{ path: '/user/dashboard' }">Dashboard</el-breadcrumb-item>
...
import {
  Odometer, Reading, Document, Expand, Fold,
  Moon, Sunny, ArrowDown, User, Lock, SwitchButton, Menu
...
/* ===== SIDEBAR FOOTER - CỐ ĐỊNH Ở ĐÁY SIDEBAR ===== */
.sidebar-footer {
  position: absolute;
  bottom: 0;
  left: 0;
...
/* ===== MAIN CONTAINER - ĐỘC LẬP VỚI SIDEBAR ===== */
.main-container {
...
@media (max-width: 768px) {
  ...
  .sidebar {
    ...
    width: 225px !important; /* Always full width on mobile */
  }
