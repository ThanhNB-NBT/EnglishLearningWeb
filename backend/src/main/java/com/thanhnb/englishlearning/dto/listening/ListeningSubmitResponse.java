...
/**
 * ✅ Response sau khi nộp bài Listening
 */
@Data
@Builder
@NoArgsConstructor
...
@Schema(description = "Listening Submit Response - Kết quả nộp bài nghe")
public class ListeningSubmitResponse {
        ...
        @Schema(description = "Thông báo về tiến trình/nâng cấp", example = "🎉 Chúc mừng! Bạn đã được nâng cấp từ A1 lên A2!")
