...
public class JacksonConfig {
    ...
    public ObjectMapper objectMapper(Jackson2ObjectMapperBuilder builder) {
        ...
        mapper.registerSubtypes(
            ...
            new NamedType(CreateTextAnswerDTO.class, "FILL_BLANK"),
            new NamedType(CreateTextAnswerDTO.class, "SHORT_ANSWER"),
            new NamedType(CreateTextAnswerDTO.class, "VERB_FORM"),
            new NamedType(CreateTextAnswerDTO.class, "ERROR_CORRECTION"),
